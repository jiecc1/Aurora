 ...
 */
public class LineChatFragment2 extends BaseFragment {
    ...
    private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("stop02") && dataThread != null) {
            ...
            } else if (action.equals("start02")) {
                rays = findSelectRays(2);
                TotalTime totalTime = (TotalTime) ACache.get(getActivity()).getAsObject("totalTime2");
                if (totalTime != null) {
            ...
            } else if (action.equals("pause02")) {
                dataThread.setRun(false);
            } else if (action.equals("restart02")) {
    ...
    public void intiData() {
        ...
        intentFilter.addAction("stop02");
        intentFilter.addAction("start02");
        intentFilter.addAction("pause02");
        intentFilter.addAction("restart02");
    ...
    class DataThread implements Runnable {
        ...
        public void run() {
            ...
            Intent intentStop = new Intent("stop02");
